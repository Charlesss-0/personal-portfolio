...
export default function Footer(): React.ReactNode {
	return (
		<footer
			id="contact-info"
			className="flex flex-col items-center pt-4 font-serif bg-primary text-primary-content"
		>
			<div className="flex flex-col items-center justify-around w-full max-w-6xl px-6 py-8 space-y-6 md:flex-row md:px-8 md:py-18 md:space-y-0">
				<div>
					<p className="mb-4 font-mono text-sm text-base-300 md:mb-8">
						Contact
					</p>

					<h2 className="text-5xl tracking-tight md:text-8xl">
						Have something <br />
